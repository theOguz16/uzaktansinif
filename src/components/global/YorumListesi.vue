...
export default {
  ...
  methods: {
    ...
    async getYorumlarFromServer() {
      try {
        ...
        const response = await axiosInstance.get(
          `https://api.fizikodev.com/soru/${soruID}/yorumlar`
        );
    ...
    async questionBegen(yorum) {
      try {
        const response = await axiosInstance.post(
          "https://api.fizikodev.com/question-begen",
          {
    ...
    async yorumBegen(yorum) {
      try {
        const response = await axiosInstance.post(
          "https://api.fizikodev.com/yorum-begen",
          {
            commentExplain: yorum.commentExplain,
          }
        );
    ...
    async yorumSil(yorum) {
      try {
        ...
        const response = await axiosInstance.delete(
          `https://api.fizikodev.com/yorumlar/${yorum._id}`,
          {
            data: {
              username: this.username,
              soruID: this.soruID,
